  ...
  return (
    <Box className={root}>
      ...
      <TextField title="Historia" text={historia} />
        <Typography variant="h3" className={hallitusTitle}>Hallitus</Typography>
        <Grid className={hallitusGrid} container spacing={2}>
          {jasenet.map((jasen, index) => {
            return (
              <Grid key={index} item xs={4} className={hallitusCard}>
